...
```bash
git clone https://github.com/<you>/saccade-llm.git
cd saccade-llm
npm install
npm run dev:web-mvp
...
眼动落点的概念（ORP、saccade distance、wrap-up effect）是公开的学术研究结论，不属于任何单一产品的专利。"saccade-llm" 命名借自该学术术语。
